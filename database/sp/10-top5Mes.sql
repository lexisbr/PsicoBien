CREATE PROCEDURE `top5Mes`(
mes varchar(50)
)
BEGIN
	select concat(usuarios.nombre,' ',usuarios.apellido) as psicologo, 
		usuarios.urlFotoPerfil,profesionales.colegiado, 
		SUM(facturas.monto) as ganancias_al_mes
	from profesionales
